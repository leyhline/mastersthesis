...
\usepackage{titling}
\title{Implementing Cast Calculus for Label-dependent Lambda Calculus}
\author{Thomas Leyh}
...
\begin{document}
    ...
    \input{chapters/2-ldlc-foundations}
    \input{chapters/3-cast-calculus}
%    \input{chapters/4-program-structure}
