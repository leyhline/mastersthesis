...
%------------------------------------------------------------------------------
    ...
    \lstset{language=Haskell,frame=lines,lineskip=1ex,basicstyle=\small}
    \lstdefinelanguage{ldgv}{
        morekeywords={let,in,rec,natrec,fst,snd,Unit,Nat,Double,Bot,Int,String,val,type,fn,case},
        sensitive=true,
        morecomment=[l]{--}
    }
...
%------------------------------------------------------------------------------
    ...
    \hypersetup{pdftitle={\thetitle},
                pdfauthor={\theauthor},
                pdfsubject={Graduate thesis at the Albert Ludwig University of Freiburg},
                pdfkeywords={programming languages, dependent types, lambda calculus},
...
\newcommand{\Direction}{\text{ \textbf{Direction} }}
...
\newcommand{\String}{\text{ \textbf{String} }}
